...
var importEs6SideEffectExp = /^([ \t]*import )(['"])(.+?)(\2;.*)$/;
var importEs6InlineExp = /^(.*?import\()(['"])(.+?)(\2\).*)$/;
...
function bundle(options) {
    ...
    function parseFile(file) {
        ...
        var code = fs.readFileSync(file, { encoding: 'utf8' }).replace(bomOptExp, '').replace(/\s*$/, '');
            ...
            if ((line.indexOf("from") >= 0 && (match = line.match(importEs6Exp))) ||
                ...
                if (fileExp.test(moduleName)) {
                    ...
                    if (!assumeExists) {
                        ...
                        var modLine = {
                            original: removeDeclares(lead + quote + getExpName(impPath) + trail)
                        };
